...
//Abre menu modal finalizar compras ao clicar (Responsivel celular)
...
//Fecha menu modal finalizar compras ao clicar (Responsivel celular)
...
function updateCart(){
    ...
    if(cart.length > 0){
        ...
        // Zera e mostra a lista do carrinho
        c('.cart').innerHTML = '';
        ...
        for (let i in cart) {
           ...
           //Exibe o tamanho da pizza escolhida
           switch(cart[i].size){
                case 0:
                    pizzaSizeName = 'P';
                    break;
